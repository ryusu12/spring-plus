...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            String message = "할 일(" + todoId + ")에 매니저(" + managerSaveRequest.getManagerUserId() + ")를 등록했습니다";
            logService.saveLogWithManager(true, user, todo.getId(), message);
            ...
            logService.saveLogWithManager(false, user, todo.getId(), e.getMessage());
            throw e;
        }
    }
